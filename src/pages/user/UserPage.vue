<template>
  <div>
    <TitleBar title="个人信息":needback="true"></TitleBar>
    <!--用户信息栏-->
    <div class="row">
      <div class="col-xs-4">
        <img src="@/assets/icon.jpg" alt="" class="img-circle img-thumbnail" style="width:80px;height:80px" />
      </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-offset-7 col-xs-2">
        <button class="btn btn-default" @click="goSelect">购买立中大奖</button>
      </div>
    </div>
